...
//    // The directory the application uses to store the Core Data store file. This code uses a directory named "JR3.ReactiveBrew" in the application's documents directory.
...
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"ReactiveBrew.sqlite"];
//    NSError *error = nil;
